...
| [`projects/usb-bridge`](projects/usb-bridge) | C11 · libusb-1.0 · USB/IP wire | Host-oldali USB/IP server az LKL vhci_hcd-nek (Fázis 1c — teljes URB loop) |
| [`projects/kali-term-app`](projects/kali-term-app) | Kotlin · Compose · NDK + CMake · `dev.hm.kaliterm` | A főalkalmazás (Phase 2a — skeleton + JNI bridge stub) |
...
projects/
  ...
  kali-term-app/     # a kaliterm Android app (Compose + NDK), dev.hm.kaliterm
